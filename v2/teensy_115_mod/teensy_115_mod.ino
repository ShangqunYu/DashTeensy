...
void CanReceive1(const CAN_message_t &msg) {
  canReceive_i(msg, 0);
  DEBUG_PRINT("canReceive1 got triggered! \n");
}

void CanReceive2(const CAN_message_t &msg) {
  canReceive_i(msg, 1);
  DEBUG_PRINT("canReceive2 got triggered! \n");
}

void CanReceive3(const CAN_message_t &msg) {
  canReceive_i(msg, 2);
  DEBUG_PRINT("canReceive3 got triggered! \n");
}
...
//   DEBUG_PRINT(Ethernet.subnetMask());
//   DEBUG_PRINT("\n");
//   DEBUG_PRINT("- Gateway: ");
//   DEBUG_PRINT(Ethernet.gatewayIP());
//   DEBUG_PRINT("\n");
//   DEBUG_PRINT("- DNS: ");
//   DEBUG_PRINT(Ethernet.dnsServerIP());
//   DEBUG_PRINT("\n");
// }
